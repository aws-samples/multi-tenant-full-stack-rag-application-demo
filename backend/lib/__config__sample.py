...
config = {
   ...
   "auth_provider_params": {
      "cognito": {
         ...
         "allowed_email_domains": ["replace_with_your_email_domain.com"],
         ...
         "cognito_domain_prefix": "multitenant-rag",
   ...
   "vector_store_provider_params": {
      ...
      "opensearch_managed": {
         ...
         # uncomment this and add your IP, and it will be added for HTTPS access
