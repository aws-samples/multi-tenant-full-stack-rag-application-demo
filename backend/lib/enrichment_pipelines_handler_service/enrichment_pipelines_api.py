...
class EnrichmentPipelinesApiStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, 
        ...
        **kwargs
        ...
        enrichment_pipelines_ssm_param_stack = ssm.StringParameter(self, 'EnrichmentPipelinesSsmParam',
        ...
        self.enrichment_pipelines_handler.add_to_role_policy(iam.PolicyStatement(
            ...
            resources=[
                f"arn:aws:ssm:{self.region}:{self.account}:parameter/{parent_stack_name}/enabled_enrichment_pipelines",
        ...
        # TODO_IN_PROGRESS move this to trigger function
