...
import multi_tenant_full_stack_rag_application.enrichment_pipelines.entity_extraction.neptune_client as neptune
...
#from multi_tenant_full_stack_rag_application.vector_store_provider.loaders.docx_loader import DocxLoader
...
#from multi_tenant_full_stack_rag_application.vector_store_provider.loaders.xlsx_loader import XlsxLoader
#from multi_tenant_full_stack_rag_application.vector_store_provider.splitters import OptimizedParagraphSplitter, Splitter
            ...
            rec["eventName"] == 'MODIFY':
                ...
                if ing_status.progress_status == 'INGESTED':
                    ...
                    if schema_response: 
                        ...
                        collection_save_result = self.document_collections_handler.update_doc_collections(collection, dch_evt)
